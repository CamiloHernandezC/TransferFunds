...
public class SwaggerConfig {
    ...
    private static final String MAINTAINER = "camehernandezcas@unal.edu.co";
    ...
    public static final ApiInfo DEFAULT = new ApiInfo("Api Documentation for Starwars",
            "This module is in charge of transfering funds for Visa", "1.0", "urn:tos", DEFAULT_CONTACT,
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(DEFAULT).produces(DEFAULT_PRODUCES)
                .select()
                .apis(RequestHandlerSelectors.basePackage( "com.visa.transferFunds.controllers" ) )
